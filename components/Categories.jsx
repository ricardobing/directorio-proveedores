      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Encuentra exactamente el tipo de proveedor que necesitas
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {CATEGORIES.map(category => (
            <Link
              key={category.value}
              href={`/proveedores?category=${category.value}`}
              className="group bg-gradient-to-br from-primary to-secondary p-6 rounded-lg text-white hover:shadow-xl transition-all transform hover:scale-105"
            >
              <div className="flex flex-col items-center text-center">
                <div className="bg-white/20 p-4 rounded-full mb-4 group-hover:bg-white/30 transition-colors">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {categoryIcons[category.value] || categoryIcons.catering}
                  </svg>
                </div>
